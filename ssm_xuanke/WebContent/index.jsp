...
<body style="display: flex;">
	...
	<div class="container" id="particles"
		...
		<div class="row">
			<div class="col-md-12">
				<h4 class="text-center animated bounceInDown">学生选课信息管理系统</h4>
			</div>
			<div class="col-md-12">
						...
						<form method="post" name="login" id="login" action=""
							...
							<div class="form-group has-feedback">
								<input name="" type="text" id="userid" value=""
									placeholder="用户的id" class="form-control" m="userid"
							...
							<div class="form-group has-feedback">
								<input name="" type="password" value="" id="password"
									placeholder="密码" class="form-control" m="password"
	...
	<script>
		...
		function submitHandler() {
			...
			var action = null;
			if (role == 'student') {
				action = "/ssm_xuanke/LoginHandler/studentlogin";
				useridEle.name = "sid";
				passwordEle.name = "spassword";
			} else if (role == 'teacher') {
				action = "/ssm_xuanke/LoginHandler/teacherlogin";
				useridEle.name = "tid";
				passwordEle.name = "tpassword";
			} else {
				action = "/ssm_xuanke/LoginHandler/adminlogin";
