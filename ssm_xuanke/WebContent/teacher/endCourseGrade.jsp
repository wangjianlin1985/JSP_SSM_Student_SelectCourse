...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<ul class="pagination">
				<li><a href="/ssm_xuanke/TeacherHandler/looksel/${requestScope.cid }/${requestScope.cname}/1">首页</a></li>
				<c:if test="${pageInfo.hasPreviousPage }">
					<li><a href="/ssm_xuanke/TeacherHandler/looksel/${requestScope.cid }/${requestScope.cname}/${pageInfo.pageNum-1}"
				...
				<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
					...
					<c:if test="${page_Num != pageInfo.pageNum }">
						<li><a href="/ssm_xuanke/TeacherHandler/looksel/${requestScope.cid }/${requestScope.cname}/${page_Num }">${page_Num }</a></li>
					</c:if>
				...
				<li><a href="/ssm_xuanke/TeacherHandler/looksel/${requestScope.cid }/${requestScope.cname}/${pageInfo.pages}">末页</a></li>
			</ul>
			</nav>
		</div>
	</div>
		...
		function add(cid,sid) {
			$("#form"+sid+cid).submit(function(){
			    ...
			    $.ajax({
			        async: false,
			        type: "POST",
			        url: '/ssm_xuanke/TeacherHandler/addGrade',
